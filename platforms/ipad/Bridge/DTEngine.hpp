...
public:
 ...
 std::vector<Stroke> snapshot() const; std::vector<Stroke> snapshotForPage(std::size_t pageIndex) const; std::size_t strokeCount() const; std::size_t sampleCount() const; std::uint64_t revision() const;
private:
